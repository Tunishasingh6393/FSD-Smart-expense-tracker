...
import { Budget, RecurringRule, Category, Transaction } from '../src/types';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl h-fit space-y-4">
          ...
          <form onSubmit={handleBudgetSubmit} className="space-y-4 text-sm mt-4">
            ...
            <div className="space-y-1.5">
              <label className="text-slate-400 text-xs font-mono font-medium">Scope of Budget</label>
              <select
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl h-fit space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-xs font-mono text-slate-400 font-medium">Configure automated subscription / bill rules. Transactions generate on-trigger.</p>
            </div>
            ...
            <form onSubmit={handleRecSubmit} className="space-y-4 text-sm mt-4">
              ...
              <div className="space-y-1.5">
                <label className="text-slate-400 text-xs font-mono font-medium">Subscription Outflow Value</label>
                <input
                  type="number"
                  step="0.01"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1.5">
                  <label className="text-slate-400 text-xs font-mono font-medium">Currency</label>
                  <select
                ...
                <div className="space-y-1.5">
                  <label className="text-slate-400 text-xs font-mono font-medium">Frequency</label>
                  <select
