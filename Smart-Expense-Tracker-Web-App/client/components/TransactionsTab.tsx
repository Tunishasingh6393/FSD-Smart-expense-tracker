          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl h-fit space-y-4">
            ...
            <form onSubmit={handleAddSubmit} className="space-y-4 font-sans text-sm mt-4">
              ...
              <div className="space-y-1.5">
                <label className="text-slate-400 text-xs font-mono font-medium">Value Amount</label>
                <div className="relative">
                  <input
                    type="number"
                    step="0.01"
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-2.5 text-white font-mono focus:border-blue-500 outline-none placeholder:text-slate-650"
                    placeholder="0.00"
                    value={amount}
              ...
              {/* Currency Selector */}
              <div className="space-y-1.5">
                <label className="text-slate-400 text-xs font-mono font-medium">Currency Feed</label>
                <select
                        ...
                        <tr key={t.id} className="hover:bg-slate-800/10 transition-colors">
                          <td className="py-3.5 px-4">
                            {isEditing ? (
                              ...
                              <div>
                                <p className="font-semibold text-white font-sans">{t.description}</p>
                          ...
                          <td className="py-3.5 px-4 text-right">
                            {isEditing ? (
                              ...
                              <div className="flex items-center justify-end space-x-1">
                                ...
                                <button
                                  className="p-1 text-slate-405 hover:text-rose-400 rounded cursor-pointer"
