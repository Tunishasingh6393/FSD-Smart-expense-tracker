    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 lg:col-span-2 shadow-2xl space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs font-mono text-slate-400">Historic 6-month visual analysis comparing income vs expense streams.</p>
            </div>
          </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl flex flex-col justify-between">
          <div className="space-y-1 mb-4">
            ...
            <p className="text-xs font-mono text-slate-400 animate-pulse">Category portions of active monthly costs</p>
          </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl relative">
        ...
        <div className="space-y-1 mb-6">
          ...
          <p className="text-xs font-mono text-slate-400">The last 5 structural updates across your accounts</p>
        </div>
